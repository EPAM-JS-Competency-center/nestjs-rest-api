...
export class CreateUserAndCartTables1662730375922 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."cart_currency_enum" AS ENUM('UAH', 'USD', 'EUR')`);
        await queryRunner.query(`CREATE TABLE "cart" ("id" SERIAL NOT NULL, "currency" "public"."cart_currency_enum" NOT NULL, "balance" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2022-09-09T13:32:59.291Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2022-09-09T13:32:59.291Z"', "user_id" integer, CONSTRAINT "CHK_6f2fa2f01444d0ae51d93624a9" CHECK ("balance" > 0), CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
